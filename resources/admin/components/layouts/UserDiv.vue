<template>
    <div class="user_div">
        <h5 class="brand-name mb-4 pl-10">Sara Hopkins<a href="javascript:void(0)" class="user_btn"><i class="icon-logout"></i></a></h5>
        <hr>
        <div class="card">
            <div class="card-body">
                <div class="media">
                    <img class="avatar avatar-xl mr-3" src="/admin/images/sm/avatar1.jpg" alt="avatar">
